  ...
  return (
    <div className="pt-28 pb-20 min-h-screen relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-8">
        ...
        {/* Demo Wallet Switcher Banner */}
        <div className="p-4 rounded-xl bg-[#1F1F1F] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-xs text-neutral-300">
            <Wallet className="w-4 h-4 text-[#00D97E]" />
            <span>Connected Test Wallet: <strong>{activeWallet.name}</strong> ({activeWallet.address.slice(0, 6)}...{activeWallet.address.slice(-4)})</span>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] text-neutral-400">Switch user:</span>
            {mockWallets.map((w) => (
              <button
                key={w.address}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl glass-panel border border-white/10 space-y-4">
            <div className="flex justify-between items-center text-xs text-neutral-400">
              ...
              <span className="text-[#00D97E] font-semibold">{progressPercent}% Collected</span>
            </div>
          ...
          <div className="p-6 rounded-2xl glass-panel border border-white/10 space-y-3 text-xs">
            <div className="text-neutral-400 font-semibold uppercase tracking-wider">Group Info</div>
        ...
        <div className="glass-panel rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
          <div className="p-6 border-b border-white/5 flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-neutral-400 mt-0.5">Live status badges update automatically upon onchain contribution.</p>
            </div>
          ...
          <div className="p-6 rounded-2xl glass-panel border border-white/10 space-y-4">
            ...
            {!isConnectedMember ? (
              <p className="text-xs text-neutral-400">
                The currently connected wallet (<code>{activeWallet.name}</code>) is not a registered member of this group. Switch wallet above to test contribution.
              </p>
            ) : hasPaidCurrentCycle ? (
              <div className="p-4 rounded-xl bg-[#00D97E]/10 border border-[#00D97E]/30 text-center space-y-2">
                ...
                <p className="text-xs text-neutral-300">
                  Your share of {amountPerMember} USDC has been deposited into the group pool.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                <p className="text-xs text-neutral-300">
                  You owe <strong>{amountPerMember} USDC</strong> for Cycle #{currentCycle}. Approve USDC allowance and click Contribute to complete your payment.
                </p>
